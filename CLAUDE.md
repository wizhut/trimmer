...
`github.com/spf13/cobra` for the CLI surface and `golang.org/x/term` for the TTY
check.
...
MIT, `Copyright (c) 2026 wizhut.tech`.
[LICENSE](LICENSE) ships inside every release archive, and the licence
